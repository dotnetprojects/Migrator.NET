...
public abstract class Generic_GetColumnsTestsBase : TransformationProviderBase
{
    ...
    public void CompositeUniqueDoesNotMarkItsIndividualColumnsUnique()
    {
        ...
        Assert.That(Provider.GetTableConstraints("CompositeUniqueMetadata").OfType<DotNetProjects.Migrator.Framework.UniqueConstraint>().Single().KeyColumns.Length == 2, Is.True);
    }
