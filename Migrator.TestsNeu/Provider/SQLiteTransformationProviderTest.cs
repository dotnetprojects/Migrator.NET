...
namespace Migrator.Tests.Providers
{
	[TestFixture]
	[Category("SQLite")]
	public class SQLiteTransformationProviderTest : TransformationProviderConstraintBase//TransformationProviderBase
	{
		...
		public void SetUp()
		{
			string constr = Helper.GetConnectionStringSQLite.ConnectionString;
			if (constr == null)
			...
			_provider = ProviderFactory.Create(ProviderTypes.SQLite, constr, "default");
