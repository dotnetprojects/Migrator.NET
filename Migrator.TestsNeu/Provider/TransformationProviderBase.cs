...
namespace Migrator.Tests.Providers
{
	...
	{
		protected ITransformationProvider _provider { get; set; }
		...
		public void AddTableBigString()
		{
			_provider.AddTable("Test",
							   ...
							   new Column("bigstring", DbType.String, 5000, ColumnProperty.Null)
				);
		}
		public void AddTable()
		{
			_provider.AddTable("Test",
							   ...
							   new Column("blobVal", DbType.Binary, ColumnProperty.Null),
							   new Column("boolVal", DbType.Boolean, ColumnProperty.Null),
							   new Column("string", DbType.String, 1000, ColumnProperty.Null)
				);
		}
		...
		public void AddTableWithPrimaryKey()
		{
			_provider.AddTable("Test",
							   ...
							   new Column("string", DbType.String, 1000)
				);
		}

		[Test]
		public void AddTableWithPrimaryKeyNonClustered()
		{
			_provider.AddTable("Test",
							   new Column("Id", DbType.Int32, ColumnProperty.PrimaryKeyNonClustered),
							   new Column("Title", DbType.String, 100, ColumnProperty.Null),
							   new Column("name", DbType.String, 50, ColumnProperty.NotNull),
							   new Column("blobVal", DbType.Binary),
							   new Column("boolVal", DbType.Boolean),
